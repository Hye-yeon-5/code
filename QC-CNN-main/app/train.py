...
epochs = 10, bs = 20, optimizer = None, criterion = None, outdir = None, file_prefix = None):  # outdir = None, file_prefix = None):
    ...
    torch.save(net.state_dict(), "modeldict.pt")
    np.save( '_training_loss.npy', tr_losses)
    np.save( '_validation_loss.npy', val_losses)
    np.save('_training_accuracy.npy', tr_accs)
    np.save('_validation_accuracy.npy', val_accs)
